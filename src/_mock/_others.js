...
export const _notifications = [...Array(9)].map((_, index) => ({
  ...
  title:
    ...
    (index === 1 &&
      `<p><strong>Jayvon Hull</strong> mentioned you in <strong><a href='#'>Steel</a></strong></p>`) ||
    (index === 2 &&
...
export const _socials = [
  {
    ...
    icon: <FacebookIcon />,
    color: "#1877F2",
    path: "https://www.facebook.com/people/City-Autos/100090048994354/",
  },
  {
    value: "instagram",
    name: "Instagram",
    icon: <InstagramIcon />,
    color: "#E02D69",
    path: "https://www.instagram.com/city_autos_ltd/",
  },
  {
    value: "linkedin",
    name: "Linkedin",
    icon: <LinkedInIcon />,
    color: "#007EBB",
    path: "https://www.linkedin.com/company/city-autos/",
  },
  {
    value: "youtube",
    name: "Youtube",
    icon: <YouTubeIcon />,
    color: "#E02D69",
    path: "https://www.youtube.com/@cityautosltd",
  },
];
