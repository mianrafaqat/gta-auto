...
export default function ComingSoonView() {
  const { days, hours, minutes, seconds } = useCountdownDate(new Date('03/20/2024 00:00'));

  const isMediumUp = useMediaQuery((theme) => theme.breakpoints.up('md'));

  return (
    <>
      <Grid container sx={{ justifyContent: 'space-between', mt: 0, paddingTop: 0 }}>
          ...
          <Box>
            <Box>
              ...
              <Typography variant="body1" sx={{ color: '#898989', mt: 1 }}>
                Exciting News! Our website is currently under construction to bring you an even
            ...
            <Box mt={2} sx={{ display: 'flex', gap: 1, mt: 5 }}>
              ...
              <Link target="_blank" href="https://apps.apple.com/us/app/city-autos/id1673149735">
                <img
                  width={128}
                  height={42}
  ...
  return (
    ...
    >
      ...
      >
        <Typography
          variant="h3"
          sx={{ textAlign: 'center', color: 'white', borderBottom: '1px solid #fff' }}
        >
          {number}
        </Typography>
