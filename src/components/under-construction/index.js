  ...
  return (
    <MotionContainer>
      ...
      <Typography sx={{ color: "text.secondary" }}>
        Exciting News! Our website is currently under construction to bring you
        an even better experience. In the meantime, you can still access all our
        services through our mobile app available on Google Play and the App
        Store. Stay tuned for updates, and thank you for your patience! For any
        urgent matters, reach out to us at &nbsp;
