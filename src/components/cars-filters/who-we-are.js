    ...
    <Box sx={{ py: 8, bgcolor: '#000', display: {md: "block", xs: "none"} }}>
      <Container maxWidth="xl">
        ...
        >
          ...
          <Typography variant="body1" sx={{ fontSize: {md: '1.1rem', xs: "0.875rem"}, lineHeight: 1.8, mb: {md: 3, xs: 2}, color: '#e0e0e0' }}>
          ...
          <Typography variant="body1" sx={{ fontSize: {md: '1.1rem', xs: "0.875rem"}, lineHeight: 1.8, mb: 1, color: '#e0e0e0' }}>
          ...
          <Typography variant="body1" sx={{ fontSize: {md: '1.1rem', xs: "0.875rem"}, lineHeight: 1.8, mb: 2, color: '#e0e0e0' }}>
